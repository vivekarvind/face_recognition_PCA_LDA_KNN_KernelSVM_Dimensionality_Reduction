function [] = Task1_Vivek_PCA_KNN()
    ...
    for i=1:5
        ...
        % Applying PCA on Feature Matrix
        train_data_1 = Vivek_PCA(train_data,4680);
        test_data_1 = Vivek_PCA(test_data,4680);
        % Applying LDA on Reduced Feature Matrix
        train_data = Vivek_LDA(train_data_1);
        test_data = Vivek_LDA(test_data_1);
